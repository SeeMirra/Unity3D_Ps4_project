...
_plt:
plt:
_mono_aot_UnityEngine_Analytics_plt:
mono_aot_UnityEngine_Analytics_plt:
_.Lp_0:
.Lp_0:

	.byte 255,37
	.long mono_aot_UnityEngine_Analytics_got - . + 12,0
	.size mono_aot_UnityEngine_Analytics_plt,.-mono_aot_UnityEngine_Analytics_plt
	.local plt_end
...
mono_image_table:
	...
	.long 1
	.string "UnityEngine.Analytics"
	.string "DC871A57-EA12-4E4E-B1FB-1EA39BC083E6"
	.string ""
	.string ""
	.balign 8
...
.section .bss
	.balign 8
	.local mono_aot_UnityEngine_Analytics_got
	.type mono_aot_UnityEngine_Analytics_got,@object
_mono_aot_UnityEngine_Analytics_got:
...
mono_aot_got_addr:
	.balign 8
	.quad mono_aot_UnityEngine_Analytics_got
.section .data
	.balign 8
_mono_aot_file_info:
mono_aot_file_info:
...
blob:
	...
	.byte 88,12,0,39,0,128,144,16,0,0,1
.section .text
...
.Lglobals:
	...
	.long 0,0
	.globl mono_aot_module_UnityEngine_Analytics_info
	.type mono_aot_module_UnityEngine_Analytics_info,@object
	.balign 8
_mono_aot_module_UnityEngine_Analytics_info:
mono_aot_module_UnityEngine_Analytics_info:
	.balign 8
	.quad .Lglobals
.section .text
	.local mem_end
